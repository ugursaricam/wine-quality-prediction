...
fixed_acidity = model_page.col1.slider('Fixed Acidity', min_value=0.01, max_value=16.0, value=0.1, step=0.01)
volatile_acidity = model_page.col1.slider('Volatile Acidity', min_value=0.01, max_value=2.0, value=0.01, step=0.01)
citric_acid = model_page.col1.slider('Citric Acid', min_value=0.01, max_value=1.5, value=0.01, step=0.01)
residual_sugar = model_page.col1.slider('Residual Sugar', min_value=0.01, max_value=16.0, value=0.1, step=0.01)
chlorides = model_page.col1.slider('Chlorides', min_value=0.001, max_value=1.0, value=0.01, step=0.001)
free_sulfur_dioxide = model_page.col1.slider('Free Sulfur Dioxide', min_value=0.01, max_value=100.0, value=0.1, step=0.01)
total_sulfur_dioxide = model_page.col1.slider('Total Sulfur Dioxide', min_value=0.01, max_value=300.0, value=0.1, step=0.01)
density = model_page.col1.slider('Density', min_value=0.0001, max_value=1.5, value=0.01, step=0.0001)
pH = model_page.col1.slider('pH', min_value=0.01, max_value=4.5, value=0.1, step=0.01)
sulphates = model_page.col1.slider('Sulphates', min_value=0.01, max_value=2.5, value=0.01, step=0.01)
alcohol = model_page.col1.slider('Alcohol', min_value=0.01, max_value=15.0, value=0.1, step=0.01)
